...
class Interface():
	...
	Attributes:
		...
		ascii (Ascii): An instance of Ascii.
		engine (Engine): An instance of Engine to be active throughout program instance.
	...
	def timer(self, current_time):
		...
		Args:
			current_time (int): From time.time() called in game_screen() method.
				Time (in seconds)
		"""
